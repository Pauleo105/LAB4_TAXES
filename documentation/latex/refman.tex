...
\input{namespacetaxes}
\chapter{Классы}
\input{classtaxes_1_1Budget}
\input{classtaxes_1_1Contract}
\input{classtaxes_1_1Payment}
\input{classtaxes_1_1Table}
\chapter{Файлы}
\input{dialog_8h}
\input{dialogcor_8h}
\input{supportfunc_8h}
\input{tax_8h}
